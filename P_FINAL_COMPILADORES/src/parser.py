...
class Parser:
    ...
    def eat(self, class_):
        if self.curr.class_ == class_:
            ...
            self.die("Se esperaba : {}, Valor encontrado: {}".format(class_.name, self.curr.class_.name))
    ...
    def program(self):
        ...
        while self.curr.class_ != Class.EOF:
            if self.curr.class_ == Class.TYPE:
                ...
                self.die("Error con inicio o cierre de programa: {}".format(self.program.__name__))
    ...
    def factor(self):
        if self.curr.class_ == Class.INT:
            ...
            self.die("Derivation error 3: {}".format(self.factor.__name__))
    ...
    def die_type(self, expected, found):
        ...
        self.die("Se esperaba : {}, Valor encontrado: {}".format(expected, found))
